let okmfields = [
    {
        ...
        { label: "Kokoelmat (sijainti): Musiikkiäänitteet", key: "collection_by_holdingbranch.musical_recordings" , sortable: true, },
        { label: "Kokoelmat (sijainti): Muut äänitteet", key: "collection_by_holdingbranch.other_recordings" , sortable: true, },
        ...
        { label: "Kokoelmat (koti): Musiikkiäänitteet", key: "collection_by_homebranch.musical_recordings" , sortable: true, },
        { label: "Kokoelmat (koti): Muut äänitteet", key: "collection_by_homebranch.other_recordings" , sortable: true, },
        ...
        { label: "Hankinnat: Musiikkiäänitteet", key: "acquisitions.musical_recordings" , sortable: true,},
        ...
        { label: "Lainaus: Musiikkiäänitteet", key: "issues.musical_recordings" , sortable: true,},
        ...
        { label: "Kaukolainaus: Yhteensä", key: "interlibrary_loans.total" , sortable: true, variant: 'success'},
        { label: "Kaukolainaus: Kirjat Yhteensä", key: "interlibrary_loans.books_total" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Suomenkieliset", key: "interlibrary_loans.books_finnish" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Ruotsinkieliset", key: "interlibrary_loans.books_swedish" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Saamenkieliset", key: "interlibrary_loans.books_sami" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Muunkieliset", key: "interlibrary_loans.books_other_lang" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Kaunokirjat, aikuiset", key: "interlibrary_loans.books_fiction_adult" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Kaunokirjat, lapset", key: "interlibrary_loans.books_fiction_juvenile" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Tietokirjat, aikuiset", key: "interlibrary_loans.books_fact_adult" , sortable: true,},
        { label: "Kaukolainaus: Kirjat Tietokirjat, lapset", key: "interlibrary_loans.books_fact_juvenile" , sortable: true,},
        { label: "Kaukolainaus: Nuotit ja partituurit", key: "interlibrary_loans.sheet_music_score" , sortable: true,},
        { label: "Kaukolainaus: Musiikkiäänitteet", key: "interlibrary_loans.musical_recordings" , sortable: true,},
        { label: "Kaukolainaus: Celia", key: "interlibrary_loans.celia" , sortable: true,},
