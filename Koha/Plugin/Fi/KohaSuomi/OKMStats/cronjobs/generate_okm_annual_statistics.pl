...
sub generateStatistics {
    ...
    if (not($okm)) {
        ...
        $okm = Koha::Plugin::Fi::KohaSuomi::OKMStats::Modules::OPLIB::OKM->new( undef, $timeperiod, $limit, $individualBranches, $verbose );
...
sub rebuildAllStatistics {
    ...
    my ($yearStart, $yearEnd) = Koha::Plugin::Fi::KohaSuomi::OKMStats::Modules::OPLIB::OKM::StandardizeTimeperiodParameter($rebuildAllStatistics);
    ...
    $okm = Koha::Plugin::Fi::KohaSuomi::OKMStats::Modules::OPLIB::OKM->new( undef, $yearStart->year(), $limit, undef, $verbose );
    $okm->createStatistics();
    $okm->save() if $okm;
    ...
    do {
        ...
        my $okm = Koha::Plugin::Fi::KohaSuomi::OKMStats::Modules::OPLIB::OKM->new( undef, $timeperiod, $limit, undef, $verbose );
        $okm->createStatistics();
        $okm->save() if $okm;
